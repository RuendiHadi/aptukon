...
<div class="container-fluid">
                    <!-- Page Heading -->
                     <div class="row">
                      <div class="col-lg-6">
                        <div class="card-body">
                           <h1 class="h3 mb-4 text-gray-800">Ubah Konsultasi</h1>
                           @if (session('sukses-tambah'))
                            <div class="alert alert-success" role="alert">
                                <b>{{ session('sukses-tambah') }}</b> 
                            </div>
                          @endif
                          <form method="POST" action="/mahasiswa/pengajuan/konsultasi/ubah/aksi/{{$data_ubah->id_konsul}}">
                            @csrf
                            ...
                            <div class="form-group">
                              ...
                              <textarea class="form-control" name="judul_skripsi">{{$data_ubah->judul}}</textarea>
                            </div>
